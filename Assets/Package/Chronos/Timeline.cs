...
namespace Chronos
{
	...
	public class Timeline : MonoBehaviour
	{
		...
		{
			timeScale = observedTimeScale = clock.timeScale;
		}
		...
		protected virtual void Update()
		{
			...
			timeScale = observedTimeScale; // Start with the time scale from local / global clock
			...
			if (requestedApply || timeScale != lastTimeScale)
			{
				Apply();
		...
		protected float observedTimeScale;
		...
		internal HashSet<IAreaClock> areaClocks;
		...
		internal virtual void ObserveTimeScale(float timeScale)
		{
			observedTimeScale = timeScale;
		}
		...
		protected virtual void Apply()
		{
			...
			{
				// Not needed anymore with manual simulation
				// particleSystem.playbackSpeed = particleSpeed * timeScale;
			}
